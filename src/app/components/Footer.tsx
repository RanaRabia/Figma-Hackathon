  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap md:text-left text-center order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        <img src="l1.png" alt="" className='mb-4' />
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600 hover:text-gray-800">Wooden Chair Chair</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Perk Chairr</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
    ...
    Support
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">Help and Support</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">Teams and Conditions</a>
          </li>
          <li>
